# Location: ara/replay_log.py
# Purpose: Replay-capable LLM interaction logging with delta encoding
# Functions: ReplayLogger (log_call, write_header, child)
# Calls: N/A
# Imports: json, time, datetime, pathlib, dataclasses
...
@dataclass
class ReplayLogger:
    """Logs every LLM API call for replay. Delta-encoded after seq 0."""
