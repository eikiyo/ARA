...
def main():
    ...
    for i,p in enumerate(papers):
        ...
        try:
            ...
            if not cs:fail+=1
                ...
                if cc:
                    res=db.store_claims(cc,session_topic="prewarm_or6");tc+=res.get("stored",0)
    ...
    _log.info("OR-6 DONE: %d claims %d papers %.1f min",tc,done,(time.time()-t0)/60)
