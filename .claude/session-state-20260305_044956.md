...
ef1e42b [feature] Parallelize search tool calls in engine + scout prompt
8936130 [fix] Remove live activity display (Thinking/Running spinner)
35459b9 [fix] Fix search API errors — retry, redirects, PubMed JSON
389383e [feature] Auto-persist model and provider across sessions
4fb33aa [fix] Add DB migration for branch_map and hypotheses columns
