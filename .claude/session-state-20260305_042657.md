...
c1b77ab [phase2] Brancher v2 iterative deepening + UI fixes + rename
678a19e [phase1] Add status bar, Ollama compatibility, and error recovery
6f73893 [phase1] Add end-to-end integration tests (Task 14) — 33 tests pass
d402460 [phase1] Complete Phase 1 tasks 2-13: DB, tools, prompts, gates, wiring
13e73d4 [phase1] Bootstrap ARA CLI package — engine runs, tools dispatch, TUI works
